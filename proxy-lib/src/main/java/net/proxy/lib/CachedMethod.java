...
import static net.proxy.lib.ProxyUtils.unwrapProxies;
    ...
    public MethodDesriptor.Result makeCall(Object source, ProxyUtils.ProxyObject... params) {
        ...
        try {
            ...
            if (this.descriptor.isStatic()) {
                return new MethodDesriptor.Result(this, method.invoke(null, unwrapProxies(params)));
            } else {
                return new MethodDesriptor.Result(this, method.invoke(source, unwrapProxies(params)));
            }
